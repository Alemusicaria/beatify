document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch('http://localhost:8080/phpmyadmin/index.php?route=/sql&pos=0&db=beatify&table=canco') // Ajusta la URL según tu configuración
        ...
        .then(data => {
            ...
            data.forEach(item => {
                ...
                imgPortada.src = item.Img; // Asegúrate de tener la propiedad adecuada en tus datos

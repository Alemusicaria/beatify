...
$sql = "SELECT canco.ID AS ID_Canco, canco.Titol, canco.ID_Genere, canco.Img, album.ID AS ID_Album, album.Foto AS Foto_Album, crea_musica.ID_Artista, artista.NomArtistic AS Nom_Artista
        FROM canco
